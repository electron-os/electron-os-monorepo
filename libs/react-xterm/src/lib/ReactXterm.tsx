...
import { Style } from './ReactXterm.styles';
import type { IReactXtermProps } from './ReactXterm.types';

import './react-xterm.module.scss';
import 'xterm/css/xterm.css';

export class Xterm extends Component<IReactXtermProps> {
  terminalRef: React.RefObject<HTMLDivElement>;
  terminal!: Terminal;

  constructor(props: IReactXtermProps) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className={this.props.className} ref={this.terminalRef} {...root} />
    );
  }
}
